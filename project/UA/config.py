...
grafana_cpuurl='?query=namespace_pod_name_container_name%3Acontainer_cpu_usage_seconds_total%3Asum_rate%7Bnamespace%3D%22uat%22%2Ccontainer_name!%3D%22POD%22%2Cpod_name%3D~%22ua-cn.*%22%7D&start={0}&end={1}&step=30'
grafana_header = {
